...
export default function TOC() {
    ...
    return (
        <Nav variant="pills">
            ...
            <Nav.Item>
                <Nav.Link as={Link} to="/Labs/Lab4" id="wd-a3" active={pathname.includes('Lab4')}>
                    Lab 4
                </Nav.Link>
            </Nav.Item>
            <Nav.Item>
                <Nav.Link as={Link} to="/Labs/Lab5" id="wd-a3" active={pathname.includes('Lab5')}>
                    Lab 5
                </Nav.Link>
            </Nav.Item>
            <Nav.Item>
            ...
            <Nav.Item>
                <Nav.Link href="https://github.com/vinayjawadagi">My GitHub</Nav.Link>
            </Nav.Item>
        </Nav>
    );
}
